...
9. TF Configuration：
   ...
   - Frame ID: ds_imu_link
   - Configuration：Publish static TF transform according to your installation setup if needed
...
- `imu/rawdata` ([sensor_msgs/Imu](http://docs.ros.org/api/sensor_msgs/html/msg/Imu.html)) raw, uncalibrated angular velocity and linear acceleration
